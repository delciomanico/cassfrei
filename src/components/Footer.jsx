          ...
          <div className="col-md-6 col-lg-4">
            <div className="ftco-footer-widget mb-5">
              ...
              <div className="block-23 mb-3 mt-4">
                <ul>
                  <li><span className="icon icon-map-marker"></span><span className="text">Rua Manuel F. Caldeira, n.º 23, 9º Distrito Urbano da Ingombota, Luanda, Angola</span></li>
                  <li><a href="tel:+244923662140"><span className="icon icon-phone"></span><span className="text">+244 923 662 140 | +244 923 764 161</span></a></li>
                  <li><a href="mailto:geral@cassfrei.com"><span className="icon icon-envelope"></span><span className="text">geral@cassfrei.com</span></a></li>
                </ul>
              </div>
            </div>
          </div>
